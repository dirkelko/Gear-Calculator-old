String.toLocaleString({
	...
	"es": {
		...
		"%speed": "Speed",
		"%gear_step": "Gear Step/%",
		"%mail": "help with spanish translation appreciated: info@ritzelrechner.de",
		"%torque_warning": "High Torque!",
		"%tt_compare": "Click to compare to display a second gearing set up",
		"%tt_mail": "send comments and feedback to this adress",
		"%tt_moveCw": "move the chainring to select another number of teeth",
	...
	"hu": {
		...
		"%tt_compare": "Kattintásra másolat készül a beállításról, melyet próbaképpen változtatgathatsz. A (megváltoztatott) másolat újabb kattintásra eltűnik.",
